...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec 30 14:43:18 2020
...
#    line += str(uwData[2])+','
    ...
    uwExecutionTimes.append(min(vanillaData[2], uwData[2]))
...
ax.set_ylabel('Time Taken by min(OR/alpha50)(seconds)')
