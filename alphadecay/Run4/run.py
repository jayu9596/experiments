...
import pandas as pd
myDir = '/home/jaydeep/Thesis/experiments/alphadecay/Run4/'
uwFolder = 'AlphaDecay3'
vanillaFolder = 'OR'
limitTo900 = False
# VanillaW
...
#    line += str(uwData[2])+','
    ...
    if limitTo900:
        if uwData[2] >= 900 or 'TIMEDOUT' in uwData[1]:
            uwExecutionTimes.append(900)
            uwExecTime = 900
        else:
            uwExecutionTimes.append(uwData[2])
        if vanillaData[2] >= 900 or 'TIMEDOUT' in vanillaData[1]:
            vanillaExecutionTimes.append(900)
            vanillaExecTime = 900
        else:
