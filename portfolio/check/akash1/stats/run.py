...
import pandas as pd
myDir = '/home/jaydeep/Thesis/experiments/portfolio/check/akash1/stats/'
uwFolder = 'portfolio_UW_alpha150_OR_same'
...
for file in allfiles:
    ...
    if ('TIMEDOUT' in uwData[1] and 'TIMEDOUT' in vanillaData[1]) or ('OK' not in uwData[1] and 'OK' not in vanillaData[1]):
        col.append('b')
    else:
    ...
    if ('TIMEDOUT' in uwData[1] and 'TIMEDOUT' in vanillaData[1]) or ('OK' not in uwData[1] and 'OK' not in vanillaData[1]):
        ...
        tempList.append('TIMED-OUT')
    elif ('TIMEDOUT' in uwData[1]) or ('OK' not in uwData[1]):
        tempList.append(vanillaFolder)
        tempList.append('TIMED-OUT')
    elif ('TIMEDOUT' in vanillaData[1]) or ('OK' not in vanillaData[1]):
...
#        line += str(percentMore)
        ...
        tempList.append('TIMED-OUT')
    line += ','
    if 'OK' not in uwData[1] and 'OK' in vanillaData[1]:
#        line += '1,'
        tempList.append('1')
    else:
#        line += '0,'
        tempList.append('0')
    if 'OK' not in vanillaData[1] and 'OK' in uwData[1]:
#        line += '1'
        tempList.append('1')
    else:
#        line += '0'
